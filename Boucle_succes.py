...
SUCCES_EXPEDITIF = "Expéditif"
SUCCES_TEMERAIRE = "Téméraire"
SUCCES_CHAMPION = "Champion"
SUCCES_CHANCEUX = "Chanceux"
SUCCES_COMPLETIONNISTE = "Complétionniste"
    ...
    def succes_expeditif():
        if Menu.expeditif:
            sous_titre_expeditif.configure(
                text=" Gagner en moins de (15s-Facile/45s-Moyen/1.10m-Difficile) ", foreground="Black")
