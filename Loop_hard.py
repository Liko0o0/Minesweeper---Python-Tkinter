...
def boucle_difficile(mute, language):
    ## ----- Son ----- ##
    mixer.init()
            ...
            if not self.marquer:
                ...
                if self.est_bombe:
                    ...
                    if Case_d.nb_case_d == 0:
                        ...
                        if rejouer == True:
                            fen.destroy()
                            boucle_difficile(mute, language)
                        else:
                            import Main
        ...
        def montre_case(self):
            if not self.est_decouvert:
                ...
                if language=='french':
                    ...
                    nb_case_restantes.configure(
                        text=f" Cell left : {Case_d.nb_case_d} ")
...
## ----- Création des canevas -----##
    # Fond
    Main = Canvas(fen, width=1110, height=740, bg='#a39193')
...
## ---- Création des informations -----##
    ...
    if language == 'english':
        ...
        nb_bombe.config(text=' Mines : 21 ')
        nb_case_restantes.config(text=' Cell left : 79 ')
