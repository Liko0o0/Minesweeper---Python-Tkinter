...
chemin_f = Path(__file__).parent / "temps_facile.txt"
...
## ----- Création des canevas -----##
    # Fond
    menu = Canvas(fen, width=700, height=470, bg='#a39193')
